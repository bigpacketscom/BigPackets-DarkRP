...
surface.CreateFont("BankFont", {font = "Arial", size = 100}) //I don't know why, but as long as this number is high the font looks fine!
function ENT:Draw()
    ...
    cam.Start3D2D(pos, ang, 0.15) 
		...
		if (self:GetNWString("BankRS_Status") == "") then   
			draw.SimpleTextOutlined("Bank Vault", "BankFont", 0, -560, Color(100, 255, 100, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 5, Color(0, 0, 0, 255))
		else
			draw.SimpleTextOutlined("Bank Vault", "BankFont", 0, -635, Color(100, 255, 100, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 5, Color(0, 0, 0, 255))
