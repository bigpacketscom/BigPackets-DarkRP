...
GM.Config.DefaultLaws = {
	...
	"Shooting weapons in the street without lockdown is illegal",
	"Graffiti is illegal",
    "Money printers and all drugs are illegal",
	"Shooting or attempting to destroy a City Scanner is illegal",
	"BHop is Illegal",
	"AntiAim (Spin Hack) is Illegal",
...
GM.Config.PocketBlacklist = {
	...
	["bank_vault"] = true,
	["dumpster"] = true,
	["packetbank_industrial"] = true,
	["packetbank_oldprinter"] = true,
	["packetbank_printer"] = true,
}
...
GM.Config.hitTargetCooldown = 45
